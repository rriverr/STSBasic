...
<link href="<c:url value='/resources/css/admin/hope_books.css' />"
							...
							<tr>
								...
								<td><c:choose>
										<c:when test="${item.hb_result eq 0}">
											<c:url value="/book/admin/registerHopeBookForm"
												var="hope_book_url">
												...
												<c:param name="hb_publish_year"
													value="${item.hb_publish_year}" />
											</c:url>
